...
namespace SetlistFmApi.Tests.Deserialization
{
    public abstract class MusicDeserializationTestsBase : DeserializationTestBase
    {
        ...
        {
            var result = deserializeFromFile<ArtistSearchResult>("artist_list");
        ...
        {
            var artist = deserializeFromFile<Artist>("artist_opeth");
        ...
        {
            var setlist = deserializeFromFile<Setlist>("setlist_metallica");
        ...
        {
            var results = deserializeFromFile<SetlistSearchResult>("setlist_list");
